...
export async function correlateTeamsAndPlayers() {
        
    const updatePlayerAttributes = async (playerId: number, attributesId: number, teamId: number) => {
        try {
